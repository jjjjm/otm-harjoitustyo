...
public class NPC {
     ...
     * @param hitBoxRadius ammuttavan alueen rajat (määrittelee siis säteen
     * ympyrälle jonka keskipiste on nykyinen x,y koordinaatti)
     * @param health
     * @param speed
     */
    ...
    /**
     * Kuljettaa NPC eteenpäin polkua pitkin (Ts. Muuttaa olion x- tai
     * y-koordinaattia riippuen speed-muuttujasta ja nykyisestä sijainnista
     * polulla
     */
